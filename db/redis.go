...
func AddStreamsData(username, content, receiver string) (string, error) {
...
// ReadStreamsData 读取流消息
func ReadStreamsData(count int64, method string) ([]redis.XMessage, error) {
